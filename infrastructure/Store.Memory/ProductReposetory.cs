...
namespace Store.Memory
{
    public class ProductReposetory : IProductRepository
    {
        ...
        {
            Product.Mapper.Map(Product.DtoFactory.Create(0, "Chees", "Podoksha", "Качотта", "Тут описание", 150m)),
            Product.Mapper.Map(Product.DtoFactory.Create(1, "Chees", "Podoksha", "Рикотта", "Тут описание", 80m)),
            Product.Mapper.Map(Product.DtoFactory.Create(2,"Chees", "Podoksha", "Качокавалла", "Тут описание", 190m)),
            Product.Mapper.Map(Product.DtoFactory.Create(3, "Chees", "Подносковье", "Адыгейский", "Тут описание", 100m)),
            Product.Mapper.Map(Product.DtoFactory.Create(4, "Chees", "Лебедева", "Маскарпоне", "Тут описание", 60m)),
            Product.Mapper.Map(Product.DtoFactory.Create(5, "Оборудование", "Podoksha", "Лира", "Тут описание", 1200m))
        };
